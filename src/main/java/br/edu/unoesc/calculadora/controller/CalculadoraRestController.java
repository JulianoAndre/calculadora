...
public class CalculadoraRestController {
    ...
    public String somarQuery(@RequestParam(value = "n1", defaultValue = "0") String n1,
    						 @RequestParam(value = "n2", defaultValue = "0") String n2,
							 RedirectAttributes atributos){
		atributos.addAttribute("v1","40");
		atributos.addFlashAttribute("v2", "42");
		
		return "redirect:/somar-path/" + n1 + "/" + n2;
		
    }
    
    @GetMapping("/somar-path/{numero1}/{numero2}")
    public String somarPath(@PathVariable String numero1,
